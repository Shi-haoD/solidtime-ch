...
<template>
    ...
    <div
        class="relative min-h-screen bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-text-primary">
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            ...
            <div class="flex justify-center px-6 mt-16 sm:items-center sm:justify-between">
                ...
                <div
                    class="text-sm text-center text-gray-500 ms-4 dark:text-gray-400 sm:text-end sm:ms-0">
